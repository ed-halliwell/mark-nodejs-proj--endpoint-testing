...
app.get("/quest/start/easy", (req, res) => {
  res.json({
    ...
    speech: {
      speaker: MYSTERIOUS_ROBED_FIGURE,
      text: "Great rookie, let's get started!",
    },
    options: {
      next: "/quest/part1easy",
      "completed it, m8": "/quest/start/impossible",
    },
  });
});
...
app.get("/quest/start/hard", (req, res) => {
  res.json({
    ...
    speech: {
      speaker: MYSTERIOUS_ROBED_FIGURE,
      text: "Great experienced one, let's get started!",
    },
    options: {
      next: "/quest/part1hard",
      "completed it, m8": "/quest/start/impossible",
    },
  });
});
...
app.get("/quest/start/impossible", (req, res) => {
  res.json({
    ...
    speech: {
      speaker: {
        name: "Death",
        description: "Black cloak, sickle - that guy.",
      },
      text: "Instant death for you my friend!",
    },
    options: {
      restart: "/",
    },
